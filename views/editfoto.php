                        ...
                        <div class="card-body px-5 py-5">
                            ...
                            <?php foreach ($foto->edit($_GET['fotoid']) as $edit) : ?>
                                <form action="../routers/r_foto.php?aksi=update" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-1">
                                        <input type="id" class="form-control" name="fotoid" value="<?= $edit->fotoid ?>" hidden>
                                        <input type="id" class="form-control" name="albumid" value="<?= $edit->albumid ?>" hidden>
                                    </div>

                                    <div class="form-group">
                                        <label>Judul Foto</label>
                                        <input type="text" class="form-control p_input" id="namaalbum" value="<?= $edit->judulfoto ?>" name="judulfoto">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="datetime-local" class="form-control p_input" id="tanggaldibuat" name="tanggaldibuat" value="" hidden>
                                    </div>
